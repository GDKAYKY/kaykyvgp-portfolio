...
export const EXPERIENCES: Experience[] = [
  {
    ...
    description: [
      "Developed,maintained and optimized Fintech Antifraud workflows and systems in an AWS Cloud Environment using C# and .NET. and JavaScript",
    ...
    technologies: ["C#", ".NET", "JavaScript", "AWS", "Docker", "Grafana"],
    projects: [
