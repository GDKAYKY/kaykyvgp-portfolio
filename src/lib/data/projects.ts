...
export const PROJECTS: Project[] = [
  {
    ...
    tags: "Tauri v2,Rust,Tokio,Reqwest,Serde,Svelte 5,TypeScript,Vite,Tailwind CSS v4,IndexedDB,Dexie,Vitest,Lucide,MCP,NVIDIA SMI",
  ...
  },
  {
    ...
    tags: "Electron,Node.js,yt-dlp,HTML5,CSS3,JavaScript,Ffmpeg,aria2c,React",
