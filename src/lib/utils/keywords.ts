...
export const KEYWORD_DICTIONARY: KeywordDictionary = {
  ...
  framework: [
    ...
    { pattern: /\bAngular\b/gi, label: "Angular" },
  ...
  tool: [
    { pattern: /\bAWS CloudWatch\b/gi, label: "AWS CloudWatch" },
    { pattern: /\bAzure\s*DevOps\b/gi, label: "Azure DevOps" },
    { pattern: /\bVPC\b/gi, label: "VPC" },
    { pattern: /\bCloud\s*IAM\b/gi, label: "Cloud IAM" },
    { pattern: /\bCompute\s*Engine\b/gi, label: "Compute Engine" },
    { pattern: /\bCloud\s*Storage\b/gi, label: "Cloud Storage" },
    { pattern: /\bDocker\b/gi, label: "Docker" },
    { pattern: /\bSonarQube\b/gi, label: "SonarQube" },
    { pattern: /\bVirtual machines\b/gi, label: "Virtual machines" },
    { pattern: /\bBizagi Modeler\b/gi, label: "Bizagi Modeler" },
    { pattern: /\bAWS S3\b/gi, label: "AWS S3" },
    { pattern: /\bGitFlow\b/gi, label: "GitFlow" },
  ...
  cloud: [
    { pattern: /\bGoogle\s*Cloud\b/gi, label: "Google Cloud" },
    { pattern: /\bComputer\s*Vision\b/gi, label: "Computer Vision" },
    { pattern: /\bAzure\b/gi, label: "Azure" },
